...
export const I18N = {
 en:{compare:'Compare',all_cards:'All cards',eligibility:'Eligibility',filter_cards:'Filter cards',category:'Category',
   ...
   elig_eyebrow:'No hard enquiry on your CIBIL',elig_h1_pre:'Find cards you\'ll ',elig_h1_em:'actually get',elig_h1_post:' approved for',
   elig_sub:'Answer 5 quick questions. See your real approval odds across {n} cards — ranked from most to least likely, no forms, no spam calls.',
   elig_trust_soft:'Soft check only',elig_trust_nodata:'No data sold',elig_trust_free:'Free forever',elig_trust_checked:'{n} cards checked',
   elig_stat_cards:'Cards checked against your profile',elig_stat_banks:'Banks across all categories',elig_stat_impact:'Impact on your CIBIL score',elig_stat_time:'To see your personalised results',elig_stat_time_val:'2 min',
   elig_q1_label:'Employment',elig_q2_label:'Monthly income',elig_q3_label:'CIBIL score',elig_q4_label:'Details',elig_q5_label:'Bank relationship',elig_selected:'Selected',
   elig_emp_salaried:'Salaried',elig_emp_self:'Self-employed',elig_emp_business:'Business owner',elig_emp_homemaker:'Home maker',elig_emp_student:'Student',elig_emp_retired:'Retired',
   elig_income_u20:'Below ₹20k',elig_income_20_40:'₹20k – ₹40k',elig_income_40_60:'₹40k – ₹60k',elig_income_60_80:'₹60k – ₹80k',elig_income_80_1l:'₹80k – ₹1L',elig_income_1l_15l:'₹1L – ₹1.5L',elig_income_15l_2l:'₹1.5L – ₹2L',elig_income_above_2l:'Above ₹2L',
   elig_cibil_below650_label:'Below 650',elig_cibil_below650_range:'300 – 649',elig_cibil_below650_desc:'Rebuilding credit',
   elig_cibil_650_label:'650 – 699',elig_cibil_650_range:'650 – 699',elig_cibil_650_desc:'Fair — improving',
   elig_cibil_700_label:'700 – 749',elig_cibil_700_range:'700 – 749',elig_cibil_700_desc:'Good — most cards',
   elig_cibil_750_label:'750+',elig_cibil_750_range:'750 – 900',elig_cibil_750_desc:'Excellent — top cards',
   elig_cibil_ntc_label:'No score yet',elig_cibil_ntc_range:'New to credit',elig_cibil_ntc_desc:'First-time users',
   elig_age_label:'Your age',elig_age_ph:'e.g. 28',elig_city_label:'City',elig_city_ph:'Select city',elig_bank_none:'None',
   elig_cta:'Check my eligibility',elig_note:'Soft check only — your CIBIL score won\'t be affected',
   elig_results_title:'Your matches',elig_results_prompt:'Answer the questions to see your ranked approval odds',
   elig_empty_pre:'Fill in the 5 questions, then hit ',elig_empty_post:' to see cards ranked by your real approval odds.',
   elig_count_match:'{n} cards match',elig_count_secured:'1 secured card for you',elig_none_match:'No cards match this profile. Try adjusting your income or CIBIL band.',
   elig_meta_ranked:'Ranked by approval odds',elig_meta_cibil:'CIBIL',
   elig_tag_high:'High approval odds',elig_tag_med:'Medium odds',elig_tag_low:'Low odds',elig_best_match:'Best match',
   elig_feat_ltf:'Lifetime free',elig_feat_lounge:'Lounge access',elig_feat_cashback:'Cashback',elig_feat_lowforex:'Low forex',
 ...
 hi:{compare:'तुलना करें',all_cards:'सभी कार्ड',eligibility:'पात्रता',filter_cards:'कार्ड फ़िल्टर करें',category:'श्रेणी',
   ...
   elig_eyebrow:'आपकी CIBIL पर कोई हार्ड पूछताछ नहीं',elig_h1_pre:'ऐसे कार्ड खोजें जिनके लिए आपको ',elig_h1_em:'सच में अप्रूवल',elig_h1_post:' मिलेगा',
   elig_sub:'सिर्फ़ 5 आसान सवालों के जवाब दें। {n} कार्ड्स पर अपने असली अप्रूवल चांस देखें — सबसे ज़्यादा से सबसे कम संभावना के क्रम में, कोई फ़ॉर्म नहीं, कोई स्पैम कॉल नहीं।',
   elig_trust_soft:'सिर्फ़ सॉफ्ट चेक',elig_trust_nodata:'डेटा नहीं बेचा जाता',elig_trust_free:'हमेशा मुफ़्त',elig_trust_checked:'{n} कार्ड जांचे गए',
   elig_stat_cards:'आपकी प्रोफ़ाइल पर जांचे गए कार्ड',elig_stat_banks:'सभी कैटेगरी के बैंक',elig_stat_impact:'आपके CIBIL स्कोर पर असर',elig_stat_time:'आपके निजी नतीजे देखने में',elig_stat_time_val:'2 मिनट',
   elig_q1_label:'रोज़गार',elig_q2_label:'मासिक आय',elig_q3_label:'CIBIL स्कोर',elig_q4_label:'जानकारी',elig_q5_label:'बैंक संबंध',elig_selected:'चुना गया',
   elig_emp_salaried:'नौकरीपेशा',elig_emp_self:'स्व-रोज़गार',elig_emp_business:'बिज़नेस ओनर',elig_emp_homemaker:'गृहिणी',elig_emp_student:'छात्र',elig_emp_retired:'रिटायर्ड',
   elig_income_u20:'₹20 हज़ार से कम',elig_income_20_40:'₹20 – ₹40 हज़ार',elig_income_40_60:'₹40 – ₹60 हज़ार',elig_income_60_80:'₹60 – ₹80 हज़ार',elig_income_80_1l:'₹80 हज़ार – ₹1 लाख',elig_income_1l_15l:'₹1 – ₹1.5 लाख',elig_income_15l_2l:'₹1.5 – ₹2 लाख',elig_income_above_2l:'₹2 लाख से ज़्यादा',
   elig_cibil_below650_label:'650 से कम',elig_cibil_below650_range:'300 – 649',elig_cibil_below650_desc:'क्रेडिट दोबारा बना रहे',
   elig_cibil_650_label:'650 – 699',elig_cibil_650_range:'650 – 699',elig_cibil_650_desc:'ठीक — सुधर रहा',
   elig_cibil_700_label:'700 – 749',elig_cibil_700_range:'700 – 749',elig_cibil_700_desc:'अच्छा — ज़्यादातर कार्ड',
   elig_cibil_750_label:'750+',elig_cibil_750_range:'750 – 900',elig_cibil_750_desc:'बेहतरीन — टॉप कार्ड',
   elig_cibil_ntc_label:'अभी कोई स्कोर नहीं',elig_cibil_ntc_range:'क्रेडिट में नए',elig_cibil_ntc_desc:'पहली बार वाले',
   elig_age_label:'आपकी उम्र',elig_age_ph:'जैसे 28',elig_city_label:'शहर',elig_city_ph:'शहर चुनें',elig_bank_none:'कोई नहीं',
   elig_cta:'मेरी पात्रता जांचें',elig_note:'सिर्फ़ सॉफ्ट चेक — आपके CIBIL स्कोर पर कोई असर नहीं',
   elig_results_title:'आपके मैच',elig_results_prompt:'अपने अप्रूवल चांस के क्रम में देखने के लिए सवालों के जवाब दें',
   elig_empty_pre:'सभी 5 सवाल भरें, फिर ',elig_empty_post:' दबाकर अपने असली अप्रूवल चांस के अनुसार कार्ड देखें।',
   elig_count_match:'{n} कार्ड मैच',elig_count_secured:'आपके लिए 1 सिक्योर्ड कार्ड',elig_none_match:'इस प्रोफ़ाइल से कोई कार्ड मैच नहीं करता। अपनी आय या CIBIL बैंड बदलकर देखें।',
   elig_meta_ranked:'अप्रूवल चांस के अनुसार क्रम में',elig_meta_cibil:'CIBIL',
   elig_tag_high:'ज़्यादा अप्रूवल चांस',elig_tag_med:'मध्यम चांस',elig_tag_low:'कम चांस',elig_best_match:'सबसे अच्छा मैच',
   elig_feat_ltf:'लाइफटाइम फ्री',elig_feat_lounge:'लाउंज एक्सेस',elig_feat_cashback:'कैशबैक',elig_feat_lowforex:'कम फॉरेक्स',
   elig_view:'कार्ड विवरण देखें',elig_apply:'अभी अप्लाई करें',
   elig_fallback_title:'आपकी प्रोफ़ाइल से कोई अनसिक्योर्ड कार्ड मैच नहीं करता',elig_fallback_body:'आपकी जानकारी के आधार पर, हम सबसे अच्छा FD-समर्थित सिक्योर्ड कार्ड दिखा रहे हैं — कोई इनकम प्रूफ या CIBIL स्कोर ज़रूरी नहीं। आपकी FD पर ब्याज मिलता रहेगा जबकि आप क्रेडिट हिस्ट्री बनाते हैं।',
   elig_secured_badge:'सिक्योर्ड · आपके लिए सुझाया गया',elig_secured_guaranteed:'गारंटीड अप्रूवल',elig_secured_fd:'₹2,000 से FD',elig_secured_noproof:'कोई इनकम प्रूफ नहीं',elig_secured_builds:'CIBIL स्कोर बनाता है'},
