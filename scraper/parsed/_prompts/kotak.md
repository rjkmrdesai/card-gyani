...
Conditions) into strict JSON. Issuer: Kotak (id: kotak).

INPUTS (read these files):
  - Extracted text : /Users/rajkumar/Desktop/Card Gyani/cardgyani-site/scraper/extracted/kotak.txt
  - Extracted tables: /Users/rajkumar/Desktop/Card Gyani/cardgyani-site/scraper/extracted/kotak.tables.json
Source document URL (for provenance): https://www.kotak.bank.in/content/dam/Kotak/files/english-rcas.pdf
Coverage hint: fee_table_all   Per-bank notes: Filename 'rcas' = Rates, Charges And Schedules. Likely the consolidated fee schedule across cards.

GOAL — return ONE JSON object exactly like this (no prose, no markdown fence):
{
  "id": "kotak",
  "bank": "Kotak",
  "source_url": "https://www.kotak.bank.in/content/dam/Kotak/files/english-rcas.pdf",
  "cards": [
    {
...
Then WRITE the JSON object to: /Users/rajkumar/Desktop/Card Gyani/cardgyani-site/scraper/parsed/kotak.json
