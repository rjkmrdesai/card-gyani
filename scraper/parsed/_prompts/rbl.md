...
Conditions) into strict JSON. Issuer: RBL Bank (id: rbl).

INPUTS (read these files):
  - Extracted text : /Users/rajkumar/Desktop/Card Gyani/cardgyani-site/scraper/extracted/rbl.txt
  - Extracted tables: /Users/rajkumar/Desktop/Card Gyani/cardgyani-site/scraper/extracted/rbl.tables.json
Source document URL (for provenance): https://webassets.rbl.bank.in/document/Credit%20Cards/RBL-MITC-final.pdf
Coverage hint: fee_table_all   Per-bank notes: Text PDF (URL has %20-encoded spaces). Card-wise fee table expected.

GOAL — return ONE JSON object exactly like this (no prose, no markdown fence):
{
  "id": "rbl",
  "bank": "RBL Bank",
  "source_url": "https://webassets.rbl.bank.in/document/Credit%20Cards/RBL-MITC-final.pdf",
  "cards": [
    {
...
Then WRITE the JSON object to: /Users/rajkumar/Desktop/Card Gyani/cardgyani-site/scraper/parsed/rbl.json
