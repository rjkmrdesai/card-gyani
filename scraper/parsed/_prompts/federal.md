...
Conditions) into strict JSON. Issuer: Federal Bank (id: federal).

INPUTS (read these files):
  - Extracted text : /Users/rajkumar/Desktop/Card Gyani/cardgyani-site/scraper/extracted/federal.txt
  - Extracted tables: /Users/rajkumar/Desktop/Card Gyani/cardgyani-site/scraper/extracted/federal.tables.json
Source document URL (for provenance): https://www.federal.bank.in/credit-cards-mitc
Coverage hint: single_or_generic   Per-bank notes: HTML landing page. It may link out to per-card MITC PDFs rather than holding the data inline - if so, follow those links and add them as child sources.

GOAL — return ONE JSON object exactly like this (no prose, no markdown fence):
{
  "id": "federal",
  "bank": "Federal Bank",
  "source_url": "https://www.federal.bank.in/credit-cards-mitc",
  "cards": [
    {
...
Then WRITE the JSON object to: /Users/rajkumar/Desktop/Card Gyani/cardgyani-site/scraper/parsed/federal.json
