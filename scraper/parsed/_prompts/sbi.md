...
Conditions) into strict JSON. Issuer: SBI (id: sbi).

INPUTS (read these files):
  - Extracted text : /Users/rajkumar/Desktop/Card Gyani/cardgyani-site/scraper/extracted/sbi.txt
  - Extracted tables: /Users/rajkumar/Desktop/Card Gyani/cardgyani-site/scraper/extracted/sbi.tables.json
Source document URL (for provenance): https://www.sbicard.com/en/most-important-terms-and-conditions.page
Coverage hint: fee_table_all   Per-bank notes: HTML page (NOT a PDF). Contains a single fee table listing ~90 card variants with annual + renewal fee + waiver. Parse the HTML table directly. Bank-wide terms: finance up to 3.75%/mo unsecured (2.75%/mo secured), forex 3.5% (with named exceptions), late-fee tiers, cash advance 2.5% (min Rs.500).

GOAL — return ONE JSON object exactly like this (no prose, no markdown fence):
{
  "id": "sbi",
  "bank": "SBI",
  "source_url": "https://www.sbicard.com/en/most-important-terms-and-conditions.page",
  "cards": [
    {
...
Then WRITE the JSON object to: /Users/rajkumar/Desktop/Card Gyani/cardgyani-site/scraper/parsed/sbi.json
