...
Conditions) into strict JSON. Issuer: IDFC FIRST (id: idfc).

INPUTS (read these files):
  - Extracted text : /Users/rajkumar/Desktop/Card Gyani/cardgyani-site/scraper/extracted/idfc.txt
  - Extracted tables: /Users/rajkumar/Desktop/Card Gyani/cardgyani-site/scraper/extracted/idfc.tables.json
Source document URL (for provenance): https://www.idfcfirst.bank.in/content/dam/idfcfirstbank/pdf/credit-card/MITC-Document-Customer.pdf
Coverage hint: segment   Per-bank notes: Text PDF. May state generic terms + per-card variations; confirm whether all variants are listed.

GOAL — return ONE JSON object exactly like this (no prose, no markdown fence):
{
  "id": "idfc",
  "bank": "IDFC FIRST",
  "source_url": "https://www.idfcfirst.bank.in/content/dam/idfcfirstbank/pdf/credit-card/MITC-Document-Customer.pdf",
  "cards": [
    {
...
Then WRITE the JSON object to: /Users/rajkumar/Desktop/Card Gyani/cardgyani-site/scraper/parsed/idfc.json
