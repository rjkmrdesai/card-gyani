...
Conditions) into strict JSON. Issuer: ICICI (id: icici).

INPUTS (read these files):
  - Extracted text : /Users/rajkumar/Desktop/Card Gyani/cardgyani-site/scraper/extracted/icici.txt
  - Extracted tables: /Users/rajkumar/Desktop/Card Gyani/cardgyani-site/scraper/extracted/icici.tables.json
Source document URL (for provenance): https://www.icici.bank.in/managed-assets/docs/personal/cards/mitc_cc.pdf
...
GOAL — return ONE JSON object exactly like this (no prose, no markdown fence):
{
  "id": "icici",
  "bank": "ICICI",
  "source_url": "https://www.icici.bank.in/managed-assets/docs/personal/cards/mitc_cc.pdf",
  "cards": [
    {
...
Then WRITE the JSON object to: /Users/rajkumar/Desktop/Card Gyani/cardgyani-site/scraper/parsed/icici.json
