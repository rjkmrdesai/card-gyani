...
Conditions) into strict JSON. Issuer: Bank of Baroda (id: bob).

INPUTS (read these files):
  - Extracted text : /Users/rajkumar/Desktop/Card Gyani/cardgyani-site/scraper/extracted/bob.txt
  - Extracted tables: /Users/rajkumar/Desktop/Card Gyani/cardgyani-site/scraper/extracted/bob.tables.json
Source document URL (for provenance): https://online.bobcard.co.in/assets/BOBCARD_MITS.pdf
Coverage hint: fee_table_all   Per-bank notes: BOBCARD (the BoB card subsidiary) calls it MITS, not MITC. Text PDF expected with card-wise fees.

GOAL — return ONE JSON object exactly like this (no prose, no markdown fence):
{
  "id": "bob",
  "bank": "Bank of Baroda",
  "source_url": "https://online.bobcard.co.in/assets/BOBCARD_MITS.pdf",
  "cards": [
    {
...
Then WRITE the JSON object to: /Users/rajkumar/Desktop/Card Gyani/cardgyani-site/scraper/parsed/bob.json
