...
Conditions) into strict JSON. Issuer: IndusInd (id: indusind).

INPUTS (read these files):
  - Extracted text : /Users/rajkumar/Desktop/Card Gyani/cardgyani-site/scraper/extracted/indusind.txt
  - Extracted tables: /Users/rajkumar/Desktop/Card Gyani/cardgyani-site/scraper/extracted/indusind.tables.json
Source document URL (for provenance): https://www.indusind.bank.in/content/dam/indusind-platform-images/home/pdf/MITC-Premium-15-6-2016.pdf
Coverage hint: segment   Per-bank notes: Dated 2016 ('Premium' segment) - OLD and may be image-based/scanned. AUTO-DETECT and OCR if text extraction is sparse. Also flag for review: this MITC may be stale; check the bank site for a newer consolidated MITC during enrichment.

GOAL — return ONE JSON object exactly like this (no prose, no markdown fence):
{
  "id": "indusind",
  "bank": "IndusInd",
  "source_url": "https://www.indusind.bank.in/content/dam/indusind-platform-images/home/pdf/MITC-Premium-15-6-2016.pdf",
  "cards": [
    {
...
Then WRITE the JSON object to: /Users/rajkumar/Desktop/Card Gyani/cardgyani-site/scraper/parsed/indusind.json
