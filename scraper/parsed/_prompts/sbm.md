...
Conditions) into strict JSON. Issuer: SBM Bank (id: sbm).

INPUTS (read these files):
  - Extracted text : /Users/rajkumar/Desktop/Card Gyani/cardgyani-site/scraper/extracted/sbm.txt
  - Extracted tables: /Users/rajkumar/Desktop/Card Gyani/cardgyani-site/scraper/extracted/sbm.tables.json
Source document URL (for provenance): https://www.sbm.bank.in/pdf/terms-conditions/SBM-Secured-Credit-Card-T&C.pdf
Coverage hint: single_or_generic   Per-bank notes: This is a T&C for SBM's SECURED (FD-linked) credit card - likely 1-2 cards only. Tag any card from here as type='secured' (FD-linked). URL '&' must be %26-encoded. The server completes a TLS1.3 handshake with openssl/curl but FAILS from Python/LibreSSL requests; fetch with `curl --tlsv1.2`. Resolved 2026-06-26.

GOAL — return ONE JSON object exactly like this (no prose, no markdown fence):
{
  "id": "sbm",
  "bank": "SBM Bank",
  "source_url": "https://www.sbm.bank.in/pdf/terms-conditions/SBM-Secured-Credit-Card-T&C.pdf",
  "cards": [
    {
...
Then WRITE the JSON object to: /Users/rajkumar/Desktop/Card Gyani/cardgyani-site/scraper/parsed/sbm.json
