...
Conditions) into strict JSON. Issuer: American Express (id: amex).

INPUTS (read these files):
  - Extracted text : /Users/rajkumar/Desktop/Card Gyani/cardgyani-site/scraper/extracted/amex.txt
  - Extracted tables: /Users/rajkumar/Desktop/Card Gyani/cardgyani-site/scraper/extracted/amex.tables.json
Source document URL (for provenance): https://www.americanexpress.com/content/dam/amex/in/legal/mitc/charge-english-mitc.pdf
Coverage hint: segment   Per-bank notes: This URL is the CHARGE-card MITC only. Amex also has credit cards with a separate MITC. During enrichment, look for the credit-card MITC too (e.g. .../mitc/credit-english-mitc.pdf) and add it as a second Amex source if found.

GOAL — return ONE JSON object exactly like this (no prose, no markdown fence):
{
  "id": "amex",
  "bank": "American Express",
  "source_url": "https://www.americanexpress.com/content/dam/amex/in/legal/mitc/charge-english-mitc.pdf",
  "cards": [
    {
...
Then WRITE the JSON object to: /Users/rajkumar/Desktop/Card Gyani/cardgyani-site/scraper/parsed/amex.json
