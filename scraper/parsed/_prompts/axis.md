...
Conditions) into strict JSON. Issuer: Axis (id: axis).

INPUTS (read these files):
  - Extracted text : /Users/rajkumar/Desktop/Card Gyani/cardgyani-site/scraper/extracted/axis.txt
  - Extracted tables: /Users/rajkumar/Desktop/Card Gyani/cardgyani-site/scraper/extracted/axis.tables.json
Source document URL (for provenance): https://www.axis.bank.in/docs/default-source/default-document-library/mitc-credit-cards.pdf
Coverage hint: fee_table_all   Per-bank notes: Text PDF. Card-wise fee table expected.

GOAL — return ONE JSON object exactly like this (no prose, no markdown fence):
{
  "id": "axis",
  "bank": "Axis",
  "source_url": "https://www.axis.bank.in/docs/default-source/default-document-library/mitc-credit-cards.pdf",
  "cards": [
    {
...
Then WRITE the JSON object to: /Users/rajkumar/Desktop/Card Gyani/cardgyani-site/scraper/parsed/axis.json
