You are stage 4 (enrichment) of the Card Gyani scraper for ONE bank: SBI (id: sbi).

INPUTS:
  - Parsed cards (names to match against): /Users/rajkumar/Desktop/Card Gyani/cardgyani-site/scraper/parsed/sbi.json
  - Candidate product listing URL: https://www.sbicard.com/en/personal/credit-cards.html
  - Per-bank notes: HTML page (NOT a PDF). Contains a single fee table listing ~90 card variants with annual + renewal fee + waiver. Parse the HTML table directly. Bank-wide terms: finance up to 3.75%/mo unsecured (2.75%/mo secured), forex 3.5% (with named exceptions), late-fee tiers, cash advance 2.5% (min Rs.500).
...
OUTPUT — write this JSON to /Users/rajkumar/Desktop/Card Gyani/cardgyani-site/scraper/enriched/sbi.json:
{
  "id": "sbi", "bank": "SBI",
...
Return ONLY: "sbi: <matched>/<total> matched, listing <ok|replaced|unresolved>" + caveats.
