You are stage 4 (enrichment) of the Card Gyani scraper for ONE bank: Kotak (id: kotak).

INPUTS:
  - Parsed cards (names to match against): /Users/rajkumar/Desktop/Card Gyani/cardgyani-site/scraper/parsed/kotak.json
  - Candidate product listing URL: https://www.kotak.com/en/personal-banking/cards/credit-cards.html
  - Per-bank notes: Filename 'rcas' = Rates, Charges And Schedules. Likely the consolidated fee schedule across cards.
...
OUTPUT — write this JSON to /Users/rajkumar/Desktop/Card Gyani/cardgyani-site/scraper/enriched/kotak.json:
{
  "id": "kotak", "bank": "Kotak",
...
Return ONLY: "kotak: <matched>/<total> matched, listing <ok|replaced|unresolved>" + caveats.
