You are stage 4 (enrichment) of the Card Gyani scraper for ONE bank: Bank of Baroda (id: bob).

INPUTS:
  - Parsed cards (names to match against): /Users/rajkumar/Desktop/Card Gyani/cardgyani-site/scraper/parsed/bob.json
  - Candidate product listing URL: https://www.bobcard.co.in/credit-card
  - Per-bank notes: BOBCARD (the BoB card subsidiary) calls it MITS, not MITC. Text PDF expected with card-wise fees.
...
OUTPUT — write this JSON to /Users/rajkumar/Desktop/Card Gyani/cardgyani-site/scraper/enriched/bob.json:
{
  "id": "bob", "bank": "Bank of Baroda",
...
Return ONLY: "bob: <matched>/<total> matched, listing <ok|replaced|unresolved>" + caveats.
